...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="nav-bar" class="wrapper nav-wrapper">
		...
		<ul class="nav nav-pills">
			...
			<div id="nav-breadcrumb" class="wrapper">
				<ul class="breadcrumb">
					...
					<li class="active"><a href="/foru/index.php/Home/Person/personInfo/campusId/1.html">个人信息</a></li>
				</ul>
			</div>
		</div><!--.index-header-->
		<div class="wrapper clearfix" >
			<div id="person-nav-side">
				...
				<ul>
					<span>资料管理</span>
					<li class="active"><a href="<?php echo U('Person/personInfo',array('campusId'=>$campusId));?>">个人信息</a></li>
			...
			<div id="person-info-body">
				...
				<!-- <form action="<?php echo U('Person/submit',array('campusId'=>$campusId));?>" name="form" method="post"> -->
					<div id="person-basic-info" <?php if ($active == "1") echo "class='none'" ?> >
						<div class="person-info-div clearfix" >
							...
							<div class="fl">
								<input type="text" id="nickname" name="nick-name" value="<?php echo ($data["nickname"]); ?>" />
							</div>
						</div>
						...
						<div class="person-info-div clearfix" >
							...
							<div class="fl">
								<input type="text" id="academy" name="academy" value="<?php echo ($data["academy"]); ?>" />
							</div>
						</div>
						<div class="person-info-div clearfix" >
							<span class="personinfo-before">QQ号:</span>
							<div class="fl">
								<input type="text" id="qq" name="qq-num" value="<?php echo ($data["qq"]); ?>" />
							</div>
						</div>
						<div class="person-info-div clearfix" >
							<span class="personinfo-before">微信号:</span>
							<div class="fl">
								<input type="text" id="weixin" name="weixin-num" value="<?php echo ($data["weixin"]); ?>" />
							</div>
						</div>
						<div class="person-info-div clearfix" >
				...
				<!-- </form> -->
				<form action="<?php echo U('Person/savePortrait',array('campusId'=>$campusId));?>" name="form" method="post" id="form1" runat="server" enctype="multipart/form-data">
						...
						<div id="change-image" class="clearfix">
							<div class="fl">
								<dl>
									...
									<dt>
										<div id="preview">
										  <img id="presentimg" src="<?php echo ($data["img_url"]); ?>" alt=""/>
									    </div>
									</dt>
								</dl>
								<p value="<?php echo ($data["new_url"]); ?>" id="new_url"/>
								<a  class="file">
										选择上传的头像
							...
							<div class="fl">
								<dl>
									...
									<dt>
										<div id="smallPreview">
										 <img id="previewimg" src="<?php echo ($data["img_url"]); ?>" alt=""/>
									    </div>
									</dt>
									<span>
	...
	<div id="campus">
		...
		<script type="text/javascript">
   			 var savePersonInfoUrl="<?php echo U('/Home/Person/savePersonInfo');?>";
   			 var $campusId=$('#index-header').attr('data-campusId');
		</script>
		<script type="text/javascript" src="/foru/Public/script/personinfo.js"></script>
