...
<body>
	...
	<div id="nav-bar" class="wrapper nav-wrapper">
		...
		<div id="nav-breadcrumb" class="wrapper">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="/foru/index.php/Home/ShoppingCart/shoppingcart/campusId/1.html">购物车</a></li>
			</ul>
		</div>
	</div><!--.index-header-->
	...
	<div class="wrapper">
		<ul id="full-discount-price" class="none">
			<?php if(is_array($preferential)): foreach($preferential as $key=>$vo): ?><li><span><?php echo ($vo["need_number"]); ?></span> <p><?php echo ($vo["discount_num"]); ?></p> </li><?php endforeach; endif; ?>
		</ul>
		<div id="checkall">
		...
		<div class="wrapper">
			...
			<?php if(is_array($shoppingcart)): foreach($shoppingcart as $key=>$shopping): ?><tr class="order-info-detailed" data-orderId="<?php echo ($shopping["order_id"]); ?>" data-fulldiscount="<?php echo ($shopping["is_full_discount"]); ?>">
					<td>
					...
					<td>
						...
						<div class="fl">
							...
							<?php if($shopping["is_full_discount"] == 1): ?><div class="full-discount-wrapper">
